...
function draw_pie_users(areaID) {

    // load data file, process data, and draw visualization
    var url0 = '{{ site.baseurl }}/{{ site.cci_data }}/cci-internal-users.json';
    var url1 = '{{ site.baseurl }}/{{ site.cci_data }}/cci-member_repos.json';
    var files = [url0,url1];
    var promises = [];
    ...
    function drawGraph(data, areaID) {
        var graphHeader = 'Organization Members';
