...
function draw_repo_creation_history(areaID, repoNameWOwner, add_title) {
    ...
    // By default do not add title, comes with page
    add_title = add_title || false;

    // load data file, process data, and draw visualization
    var url = '{{ site.baseurl }}/{{ site.cci_data }}/cci-creation_history.json';
    var files = [url];
    ...
    function drawGraph(data, data2, dataR, dataR2, areaID, add_title) {
    ...
    function reformatData(obj) {
        ...
        repos.forEach(function(repo) {
            ...
            var tCommit = obj['data'][repo]['firstCommitAt']
            if (!tCommit) {
                tCommit = tCreate
            } else {
                tCommit = tCommit.split('T');
            }
